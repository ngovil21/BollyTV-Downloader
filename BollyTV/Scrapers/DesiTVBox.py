...
HOST_NAME = "DesiTVBox"
URL_HOME = "https://www.desitvbox.info/"
...
def Download(channel, shows, hd=False, verbose=False):
    # get channel
    ...
    if len(tree) == 0:  # If no channels found, print error.
        print("Problem parsing channels. Site may have changed layout. Check xpath!")
        return
    for a in tree:
        if verbose:
            print(a.text)
